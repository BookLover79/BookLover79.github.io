...
![image-20251209164355260](2025_使用 VSCode Compare Folders 对比两个项目的差异-20251209/image-20251209164355260.png)

## 2. 将两个项目文件夹加入工作区

在 VSCode 顶部栏选择：文件 → 将文件夹添加到工作区，分别选择你要对比的两个项目目录。

![image-20251209164642514](2025_使用 VSCode Compare Folders 对比两个项目的差异-20251209/image-20251209164642514.png)

## 3. 在工作区中选择两个项目进行对比

按住 **Ctrl**，同时在左侧资源管理器中选中这两个文件夹，右键 → **Compare Folders**

![image-20251209164656886](2025_使用 VSCode Compare Folders 对比两个项目的差异-20251209/image-20251209164656886.png)
...
![image-20251209164847774](2025_使用 VSCode Compare Folders 对比两个项目的差异-20251209/image-20251209164847774.png)

## 5. 单击文件即可查看修改内容

点击任意文件，即可直接看到两边具体有哪些差异。

![image-20251209165002259](2025_使用 VSCode Compare Folders 对比两个项目的差异-20251209/image-20251209165002259.png)
